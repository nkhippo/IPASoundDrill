...
- TTS は GAS プロキシ + Drive/localStorage キャッシュ（Drive 直リンク `?urls=1` 対応。運用手順は `gas/README.md` / `docs/reference/remaining-ops-checklist.md`）
...
| `docs/REPOSITORY-STRUCTURE.md` | **フォルダ構成マップ（Claude 共有用・最初に読む）** |

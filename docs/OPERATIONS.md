...
- ビルドコマンド: なし（静的サイト）
- 出力ディレクトリ: リポジトリルート
- Vercel ダッシュボード: https://vercel.com/nkhippo/ipasounddrill
...
1. https://vercel.com/nkhippo/ipasounddrill/deployments
...
- **Hostinger**: `ipasounddrill.app` (Order #207945639)
- 更新: 1年後（2027-07-10 前後）、自動更新推奨

### 4.2 DNS 設定

Vercel の指示に従い、以下を Hostinger 側で設定:
...
- Hostinger のアカウントに支払い方法を登録済みか確認
- 自動更新を有効化
- 更新 30日前にリマインダー通知が来る設定

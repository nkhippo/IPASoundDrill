...
> **Last updated:** 2026-07-20（Issue #100: `docs/agent-reports/` を正本 docs に整合）
...
| **`docs/agent-reports/`** | AI エージェント実装レポート統合ディレクトリ（正本: `AGENTS.md`） | 2026-07-20 以降の実装レポート（Codex / Cursor / Claude Code 等） |
...
**履歴ドキュメント:** `docs/cursor/reports/` は 2026-07-20 以前の historical archive。2026-07-20 以降の実装レポート正本は `docs/agent-reports/`（規約は repo root の `AGENTS.md`）。古いレポートは当時の語数・パスを引用する場合あり。数値・パスの正本は上表。
...
│   ├── agent-reports/           # AI エージェント実装レポート統合（Codex / Cursor / Claude Code 等）。規約: AGENTS.md

...
| **`docs/design/`** | Phase 1+ のデザイン入力資料（タグライン候補等） | Claude Design ブリーフ・LP コピー検討（例: `tagline-candidates.md`）、Phase 1 screen/data mapping |
...
**Notes**:
- 総 leaf 数: **169**（runtime 165 + build-only meta 4。2026-07-16 時点）

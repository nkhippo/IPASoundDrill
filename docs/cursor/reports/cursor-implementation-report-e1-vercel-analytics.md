...
- 動的（本番・Naoya 確認 2026-07-12）:
  - Vercel Analytics（Production / Last 7 Days）で Visitors **1** / Page Views **1** を確認
  - Pages に `/fil` が記録（言語サブディレクトリ経由）
  - 「1 online」表示あり → 計測タグ埋め込みは本番で有効
...
- Phase 4 の Feedback 側（Tally / X DM）は Issue E2

...
| 前提 | 状態 |
|------|------|
| gloss 品質（多言語UI） | en/ja/zh/ko/fil **実装済み**（既存3,059語 + Phase 1 M1:180 + M2:400、合計3,639語） |
...
| B1/B2 語彙の実データ | **B1: 927語（M1: 180語 + M2: 400語の Phase 1 拡充分を含む）/ B2: 330語**。CEFR-J 完全版との差分（B1: 1,189語 / B2: 2,186語）を Phase 1 M3以降 / Phase 2 で拡充予定 |

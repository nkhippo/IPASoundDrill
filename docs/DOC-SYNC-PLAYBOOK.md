...
- `docs/cursor/reports/` 配下の全ファイル（実装レポート）
- 検索キーワード:
  - 「削除」「除去」「廃止」「削減」「撤去」「取り除く」
...
- `docs/DOCUMENT-MAP.md`, `docs/DEV-GUARDRAILS.md`, `docs/DOC-SYNC-PLAYBOOK.md`, `docs/CURSOR-INSTRUCTION-GUIDE.md`（AI 向けガイド、実装ではなくルールの集合）

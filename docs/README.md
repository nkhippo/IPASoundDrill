...
> Last updated: 2026-07-20（Issue #100: `docs/agent-reports/` 索引追加）
...
| [`cursor/`](cursor/) | Cursor / Claude の指示書・設計ブリーフ・recon。`reports/` は historical archive（2026-07-20 以前） | [[pj-2026-07-10-a25d|`cursor/README.md`]] |

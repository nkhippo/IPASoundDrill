...
| フォルダ | 役割 | README |
|----------|------|--------|
| [`agent-reports/`](agent-reports/) | AI エージェント（Codex / Cursor / Claude Code 等）の実装レポート統合（2026-07-20 以降の正本）。規約は repo root `AGENTS.md` | [[pj-2026-07-20-e7a1|`agent-reports/README.md`]] |

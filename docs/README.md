...
> Last updated: 2026-07-20（docs/agent-reports/ 索引追加）
...
| フォルダ | 役割 | README |
|----------|------|--------|
| [`agent-reports/`](agent-reports/) | AI エージェント（Codex / Cursor / Claude Code 等）の実装レポート統合ディレクトリ | [`agent-reports/README.md`](agent-reports/README.md) |

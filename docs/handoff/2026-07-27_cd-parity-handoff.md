...
- **Phase 3 app 実装**:
  ...
  - ⏭️ **次 CD ラウンド(Naoya 適用予定)**: CD-22 / B-1(発音ポイント サブカード) / B-2(答えペイン整形) / A-3(未回答フレーム) / CD-14(3a/3c/3d 見出し) / 1a-pc キャプション修正。→ 反映・エクスポート後に **repo CD を一括同期** → app 一致実装(ドリル骨格・語彙2カラム含む)。

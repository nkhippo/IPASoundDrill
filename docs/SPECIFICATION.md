...
**リポジトリ構成:** `docs/repo-map.md`（フォルダマップ・AI向け）  
...
wordlist / connected_speech / weak_forms / guide の JSON スキーマ、localStorage、セッション状態 `S`、i18n スキーマは
`docs/data-contract.md` へ移設（Issue #172）。
...
| 関連ドキュメント | `PURPOSE.md`, `DESIGN.md`, `docs/repo-map.md`, `docs/data-contract.md`, `gas/README.md`, `docs/reference/rp-tts-design-and-priority.md` |
